...
<body id="page-top">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="listeMedecin.php">Afficher les Medecins</a>
          </div>
        </div>
      </li>
 ...
 <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="ajoutsec.php">Ajouter un Secretaire</a>
            <a class="collapse-item" href="listesec.php">Afficher les Secretaires</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="eservice.php">
          ...
          <span>Espace Service et Specialite </span></a>
      </li>
